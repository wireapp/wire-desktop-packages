...
export class ConfigVerifier {
  public static readonly BLAKE2B_HASH_BYTES: number = 64; // crypto_generichash_BYTES_MAX
...
export class ConfigDownloader {
  ...
  public static readonly UPDATE_SPEC = updateProto;
}

export class ConfigEnvelopeGenerator {
  public static readonly FILENAME_CHECKSUM_LENGTH: number = 16;
}

export class ConfigWrapperOutdated {
